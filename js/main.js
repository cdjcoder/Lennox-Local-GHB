...
window.addEventListener('load', function() {
    ...
    if (loaderWrapper) {
        ...
        }, 3500); // Show loader for 3.5 seconds after page loads
    }
});
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    */
    ...
    const responses = {
        ...
        'contact': 'You can reach us at (562) 282-9498 or email LennoxLocalAds@gmail.com',
    ...
    const responsesEs = {
        ...
        'contacto': 'Puedes comunicarte con nosotros al (562) 282-9498 o por correo electrónico a LennoxLocalAds@gmail.com',
